...
plotting the projection over the different mini-BZs. We try to change also the moire potential phase to see if
the weight shifts to other bands.
...
compute_X = True   #X feature (EDC)
compute_projection = False   #projection of side bands on mini-BZs
