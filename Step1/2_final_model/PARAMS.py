...
#        dic_params_H[M][captions[i]] = dic_params_DFT[M][captions[i]]  #use DFT values
...
def find_t(TMD):
    ...
    t[0][3,3] = dic_params_H[TMD]['t1_44']
    t[0][4,4] = dic_params_H[TMD]['t1_55']
    t[0][5,5] = dic_params_H[TMD]['t1_66']
    t[0][6,6] = dic_params_H[TMD]['t1_77']
    t[0][7,7] = dic_params_H[TMD]['t1_88']
    t[0][8,8] = dic_params_H[TMD]['t1_99']
    t[0][9,9] = dic_params_H[TMD]['t1_1010']
    t[0][10,10] = dic_params_H[TMD]['t1_1111']
    t[0][2,4] = dic_params_H[TMD]['t1_35']
    t[0][5,7] = dic_params_H[TMD]['t1_68']
    t[0][8,10] = dic_params_H[TMD]['t1_911']
    t[0][0,1] = dic_params_H[TMD]['t1_12']
    t[0][2,3] = dic_params_H[TMD]['t1_34']
    t[0][3,4] = dic_params_H[TMD]['t1_45']
    t[0][5,6] = dic_params_H[TMD]['t1_67']
    t[0][6,7] = dic_params_H[TMD]['t1_78']
    t[0][8,9] = dic_params_H[TMD]['t1_910']
    t[0][9,10] = dic_params_H[TMD]['t1_1011']
    t[4][3,0] = dic_params_H[TMD]['t5_41']
    t[4][2,1] = dic_params_H[TMD]['t5_32']
    t[4][4,1] = dic_params_H[TMD]['t5_52']
    t[4][8,5] = dic_params_H[TMD]['t5_96']
    t[4][10,5] = dic_params_H[TMD]['t5_116']
    t[4][9,6] = dic_params_H[TMD]['t5_107']
    t[4][8,7] = dic_params_H[TMD]['t5_98']
    t[4][10,7] = dic_params_H[TMD]['t5_118']
    t[5][8,5] = dic_params_H[TMD]['t6_96']
    t[5][10,5] = dic_params_H[TMD]['t6_116']
    t[5][8,7] = dic_params_H[TMD]['t6_98']
    t[5][10,7] = dic_params_H[TMD]['t6_118']
...
def find_e(TMD):
    ...
    e[1] = e[0]
    e[2] = dic_params_H[TMD]['e3']
    e[3] = dic_params_H[TMD]['e4']
    e[4] = e[3]
    e[5] = dic_params_H[TMD]['e6']
    e[6] = dic_params_H[TMD]['e7']
    e[7] = e[6]
    e[8] = dic_params_H[TMD]['e9']
    e[9] = dic_params_H[TMD]['e10']
    e[10] = e[9]
    return e
...
def find_HSO(TMD):
    M = TMD[0] if TMD[0] == 'W' else TMD[:2]
    X = TMD[1:-1] if TMD[0] == 'W' else TMD[2:-1]
    l_M = dic_params_SO[M]
    l_X = dic_params_SO[X]
    ####
